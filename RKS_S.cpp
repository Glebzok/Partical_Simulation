...
double RKS::k2(int i, Force* f){
    return h * (*f)(
        ...
        x.at(2).at(i) + k1(i, funs.at(2)) / 2,
        x.at(3).at(i) + k1(i, funs.at(3)) / 2,
        x.at(4).at(i) + k1(i, funs.at(4)) / 2,
        x.at(5).at(i) + k1(i, funs.at(5)) / 2,
        m
        );
}
...
double RKS::k3(int i, Force* f){
    return h * (*f)(
        ...
        x.at(2).at(i) + k2(i, funs.at(2)) / 2,
        x.at(3).at(i) + k2(i, funs.at(3)) / 2,
        x.at(4).at(i) + k2(i, funs.at(4)) / 2,
        x.at(5).at(i) + k2(i, funs.at(5)) / 2,
        m
        );
}
...
double RKS::k4(int i, Force* f){
    return h * (*f)(
        ...
        x.at(2).at(i) + k3(i, funs.at(2)),
        x.at(3).at(i) + k3(i, funs.at(3)),
        x.at(4).at(i) + k3(i, funs.at(4)),
        x.at(5).at(i) + k3(i, funs.at(5)),
        m
        );
}
...
vector<vector<double>> RKS::solve(){
    ...
    return{ t, x.at(0), x.at(1), x.at(2), x.at(3), x.at(4), x.at(5) };
}
